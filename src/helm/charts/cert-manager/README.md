...
$ helm install my-release --namespace cert-manager --version v1.9.0 jetstack/cert-manager
```
...
| `webhook.image.tag` | Webhook image tag | `v1.9.0` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.9.0` |
...
| `startupapicheck.image.tag` | startupapicheck image tag | `v1.9.0` |
